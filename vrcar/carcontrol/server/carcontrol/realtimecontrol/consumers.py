...
def ws_connect(message):
    ...
    # form /chatroom/{label}/, and finds a Room if the message path is applicable,
...
def ws_receive(message):
    ...
    # Parse out a chatroom message from the content text, bailing if it doesn't
    ...
    if data:
        log.debug('chatroom message room=%s handle=%s message=%s', 
